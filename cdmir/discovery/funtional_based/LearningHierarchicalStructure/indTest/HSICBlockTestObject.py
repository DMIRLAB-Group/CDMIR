        ...
        for bb in range(num_blocks):
            ...
            if self.nullvarmethod == 'permutation':
                block_statistics[bb], null_samples[bb], _, _, _, _, _ = \
                    self.HSICmethod(data_x=data_xb, data_y=data_yb, unbiased=True, num_shuffles=1,
                ...
                block_statistics[bb], _, null_varx[bb], null_vary[bb], _, _, _ = \
                    self.HSICmethod(data_x=data_xb, data_y=data_yb, unbiased=True, num_shuffles=0,
                                    estimate_nullvar=True, isBlockHSIC=True)
